 ...
 * @type {string}
 */
dj.components.StickyElementComponent.prototype.ACTIVE_CLASS = 'stuck';

/**
 * @inheritDoc
 */
dj.components.StickyElementComponent.prototype.init = function()
{
 ...
 * @private
 */
dj.components.StickyElementComponent.prototype.checkPosition_ = function(position)
{
    if (this.sticking_) {
 ...
 * @private
 */
dj.components.StickyElementComponent.prototype.stickElement_ = function(position)
{
    this.sticking_ = true;
    ...
    goog.dom.classlist.enable(this.getElement(),
        dj.components.StickyElementComponent.prototype.ACTIVE_CLASS, this.sticking_);
 ...
 * @private
 */
dj.components.StickyElementComponent.prototype.unstickElement_ = function()
{
    this.sticking_ = false;
    this.enableGhost_(this.sticking_);
 ...
 * @private
 */
dj.components.StickyElementComponent.prototype.createGhost_ = function()
{
 ...
 */
dj.components.StickyElementComponent.prototype.enableGhost_ = function(enable)
{
    goog.style.setStyle(this.ghostElement_, {
        'visiblity': 'hidden',
        'display': enable ? '' : 'none'
 ...
 *
 */
dj.components.StickyElementComponent.prototype.updateOffset_ = function()
{
